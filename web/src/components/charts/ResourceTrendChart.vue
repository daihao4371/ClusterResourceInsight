<template>
  <div class="w-full h-80 relative">
    ...
    <!-- 图例 -->
    <div class="absolute top-4 right-4 bg-dark-800/80 backdrop-blur-sm rounded-lg p-3 space-y-2">
    ...
    <div
      ...
      class="absolute bg-dark-900/95 backdrop-blur-sm text-white text-xs px-3 py-2 rounded-lg border border-gray-600 pointer-events-none z-10"
