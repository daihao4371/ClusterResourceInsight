<template>
  <nav class="fixed top-0 left-0 right-0 z-50 h-16 glass-card border-b border-white/10">
    <div class="flex items-center justify-between px-6 h-full">
      ...
      <div class="flex items-center space-x-4">
        <div class="flex items-center space-x-3">
          ...
          <div>
            <h1 class="text-xl font-semibold text-gradient">ClusterResourceInsight</h1>
            <p class="text-xs text-gray-400">K8s多集群资源监控平台</p>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center space-x-4">
        ...
        <button 
          ...
          class="btn-secondary p-2 w-10 h-10 flex items-center justify-center"
        ...
        <!-- 设置按钮 -->
        <button class="btn-secondary p-2 w-10 h-10 flex items-center justify-center">
